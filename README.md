![Cover](/Users/yonwang/Desktop/ROC Curve/ROC Plot (Version 3).jpeg)
...
head(Dt)
```
![](/Users/yonwang/Desktop/ROC Curve/Dataset.png)
...
p_ROC1
```
![](/Users/yonwang/Desktop/ROC Curve/ROC Plot (Version 1).jpeg)
...
p_ROC2
```
![](/Users/yonwang/Desktop/ROC Curve/ROC Plot (Version 2).jpeg)
...
p_ROC3
```
![](/Users/yonwang/Desktop/ROC Curve/ROC Plot (Version 3).jpeg)
...
p_ROC4
```
![](/Users/yonwang/Desktop/ROC Curve/ROC Plot (Version 4).jpeg)
